...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnMapReadyCallback {
    ...
    * */
    public void initDrawerLayout() {
        ...
        TextView tvAbout, tvFeedback, tvShare, tvHouseArea, tvCreateArea;
        ...
        tvCreateArea =(TextView) MenuItemCompat.getActionView(navigationView.getMenu().findItem(R.id.menuCreateArea));
        ...
        customMenuItemDrawer(tvCreateArea, "Đăng tin", 160);
        tvCreateArea.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
